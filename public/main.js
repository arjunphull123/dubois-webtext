...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function switchContent(id) {
      ...
      const [vizURL, author, inspoURL, inspoCaption, inspoText, purposeText, methodologyText] = vizRefs[id];
...
const vizRefs = {
  'blackSpace':  ['https://dubois-black-space.netlify.app/',
                  ...
                  'We developed <i>Black Space and the Environment</i> using a'],
